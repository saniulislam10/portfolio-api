...
const validateData = async (data) => {
    const product = new Skill(data); // Create an instance of the model
    try {
...
exports.add = async (req, res, next) => {
    ...
    try {
        ...
        const newPump = await skill.save();
...
exports.edit = async (req, res, next) => {
    ...
    try {
        ...
        const skill = await Skill.updateOne(req.body);
...
exports.delete = async (req, res, next) => {
    try {
        ...
        const update = await Skill.findByIdAndDelete(id);
